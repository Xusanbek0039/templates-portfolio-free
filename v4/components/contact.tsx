          ...
          >
            ...
            <motion.div variants={staggerContainer} className="space-y-6">
              <motion.div variants={fadeIn} className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:suyunov.husan@example.com"
                    className="text-gray-400 hover:text-green-500 transition-colors"
                  >
                    suyunov.husan@example.com
                  </a>
                </div>
              </motion.div>
            ...
            <motion.div variants={fadeIn} className="mt-12">
              ...
              <div className="flex gap-4">
                <a
                  href="#"
                  className="p-3 bg-green-500/10 rounded-lg text-green-500 hover:bg-green-500/20 transition-colors"
                  aria-label="GitHub"
                >
              ...
              <div className="grid grid-cols-1 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    required
                    className="min-h-[150px] bg-gray-800 border-gray-700 focus:border-green-500 focus:ring-green-500"
                  />
                </div>
              </div>
              <Button type="submit" className="w-full bg-green-500 hover:bg-green-600 text-black font-medium" size="lg">
                Send Message
